...
namespace UserManagement.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Commenting below as GetLogins implementation needs to be updated
            //var linkedAccounts = UserManager.GetLogins<User,int>(User.Identity.GetUserId<int>());
        ...
        {
            // Commenting below as FindById implementation needs to be updated
            //var user = UserManager.FindById<User,int>(User.Identity.GetUserId<int>());
            //if(user != null)
            //{
